...
namespace ErrorOr.Http.Generated
{
    public static class ErrorOrEndpointMappings
    {
        ...
        {
            app.MapMethods(@"/users/{id}/orders", new[] { "GET" }, (RequestDelegate)Invoke_Ep0)
            .WithMetadata(new global::Microsoft.AspNetCore.Routing.EndpointNameAttribute("global::Endpoints_GetOrders"))
            .WithMetadata(new global::Microsoft.AspNetCore.Http.TagsAttribute("global::"))
            .WithMetadata(new global::Microsoft.AspNetCore.Mvc.ProducesResponseTypeAttribute(typeof(global::Order), 200))
        ...
        private static async Task Invoke_Ep0(HttpContext ctx)
        {
            ...
            var result = await global::Endpoints.GetOrders(p0);
