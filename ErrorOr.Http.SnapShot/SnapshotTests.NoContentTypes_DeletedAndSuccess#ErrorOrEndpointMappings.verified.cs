...
namespace ErrorOr.Http.Generated
{
    public static class ErrorOrEndpointMappings
    {
        ...
        {
            app.MapMethods(@"/users/{id}", new[] { "DELETE" }, (RequestDelegate)Invoke_Ep0)
            .WithMetadata(new global::Microsoft.AspNetCore.Routing.EndpointNameAttribute("global::Endpoints_DeleteUser"))
            ...
            app.MapMethods(@"/users/{id}/activate", new[] { "POST" }, (RequestDelegate)Invoke_Ep1)
            .WithMetadata(new global::Microsoft.AspNetCore.Routing.EndpointNameAttribute("global::Endpoints_ActivateUser"))
            .WithMetadata(new global::Microsoft.AspNetCore.Http.TagsAttribute("global::"))
            .WithMetadata(new global::Microsoft.AspNetCore.Mvc.ProducesResponseTypeAttribute(204))
        ...
        private static async Task Invoke_Ep0(HttpContext ctx)
        {
            ...
            var result = global::Endpoints.DeleteUser(p0);
        ...
        {
            if (!TryGetRouteValue(ctx, "id", out var p0Raw) || !int.TryParse(p0Raw, out var p0)) { await TypedResults.BadRequest().ExecuteAsync(ctx); return; }
            var result = global::Endpoints.ActivateUser(p0);
            var response = result.Match<global::Microsoft.AspNetCore.Http.IResult>(
                _ => TypedResults.NoContent(),
                errors => ToProblem(errors));
            await response.ExecuteAsync(ctx);
