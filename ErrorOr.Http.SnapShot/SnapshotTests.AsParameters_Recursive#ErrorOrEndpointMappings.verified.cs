...
namespace ErrorOr.Http.Generated
{
    public static class ErrorOrEndpointMappings
    {
        public static void MapErrorOrEndpoints(this IEndpointRouteBuilder app)
        {
            ...
            .WithMetadata(new global::Microsoft.AspNetCore.Routing.EndpointNameAttribute("global::Endpoints_Search"))
        ...
        private static async Task Invoke_Ep0(HttpContext ctx)
        {
            ...
            {
                if (!int.TryParse(p0_c2Raw, out var p0_c2Temp)) { await TypedResults.BadRequest().ExecuteAsync(ctx); return; }
                p0_c2 = p0_c2Temp;
            }
