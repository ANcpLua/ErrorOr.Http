...
namespace ErrorOr.Http.Generated
{
    public static class ErrorOrEndpointMappings
    {
        ...
        {
            app.MapMethods(@"/webhook", new[] { "POST" }, (RequestDelegate)Invoke_Ep0)
            .WithMetadata(new global::Microsoft.AspNetCore.Routing.EndpointNameAttribute("global::Handlers_Webhook"))
        ...
        private static async Task Invoke_Ep0(HttpContext ctx)
        {
            ...
            var p0 = form;
            var result = global::Handlers.Webhook(p0);
